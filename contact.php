...
$sql="INSERT INTO  tblcontactusquery(name,EmailId,ContactNumber,Message,reg_id) VALUES('$name','$email','$contactno','$message', '$id')";
...
//$connect = mysqli_connect("localhost", "root", "", "my_db");
 $query = "SELECT  * FROM registration id = ".$_SESSION['user'][1];
...
{ ?>
            <div class="col-lg-4 mb-4">
                ...
                <p>
                    <abbr title="Phone">Phone</abbr>: <?php   echo htmlentities($result->ContactNo); ?>
                </p>
                <p>
                    <abbr title="Email">Email</abbr>: <a href="mailto:name@example.com"><?php   echo htmlentities($result->EmailId); ?>
                    </a>
                </p>
              <?php }} ?>
            </div>
