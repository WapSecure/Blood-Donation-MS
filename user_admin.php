...
//$connect = mysqli_connect("localhost", "root", "", "my_db");
 ...
 <html>
      ...
      <form class="form-inline my-2 my-lg-0" id="nav-form">
            <h3>Welcome Admin</h3>
        <br>
        <?php if(isset($_SESSION['user'])) { echo $_SESSION['user'][2];} ?>
        ...
        <form class="form-inline my-2 my-lg-0" id="nav-right-form">
          <a href="adminreq.php"><button type="button" class="btn btn-link" id="nav-btn" data-toggle="modal" data-target="#contactModal"><i class="fas fa-cart-plus"></i> Blood Requests</button></a>
            <a href="admindonate.php"><button type="button" class="btn btn-link" id="nav-btn" data-toggle="modal" data-target="#contactModal"><i class="fas fa-cart-plus"></i> Donors Detail</button></a>
            <a href="user_admin.php"><button type="button" class="btn btn-link" id="nav-btn" data-toggle="modal" data-target="#contactModal"><i class="fas fa-cart-plus"></i> Users</button></a>
        </form>
    </nav>
           <br /><br />
           <div class="container" style="width:700px;">
           <h1 align="center">Registerd Users</h1>
                <h4 align="center">Blood Bank</h4>
                <br />
                     ...
                     <div id="donor_table">
                          <table class="table table-bordered">
                               ...
                               <tr>
                                    ...
                                    <td><input type="button" name="edit" value="Update" id="<?php echo $row["id"]; ?>" class="btn btn-warning btn-sm edit_data" /></td>
                                    <td><input type="button" name="view" value="view" id="<?php echo $row["id"]; ?>" class="btn btn-info btn-sm view_data" /></td>
                                    <td><input type="button" name="delete" value="remove" id="<?php echo $row["id"]; ?>" class="btn btn-danger btn-sm btn_delete" /></td>
